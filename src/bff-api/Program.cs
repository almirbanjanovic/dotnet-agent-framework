...
// Port binding is driven by ASPNETCORE_URLS (Aspire AppHost), the
// Kestrel:Endpoints section in appsettings.Local.json (generated by
// setup-local), or the container platform (AKS / Helm) — not hardcoded.
