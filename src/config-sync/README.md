...
| crm-agent | 4 | Foundry--ProjectEndpoint, Foundry--DeploymentName, CrmMcp--BaseUrl, AzureAd--TenantId |
| product-agent | 5 | Foundry--ProjectEndpoint, Foundry--DeploymentName, KnowledgeMcp--BaseUrl, CrmMcp--BaseUrl, AzureAd--TenantId |
