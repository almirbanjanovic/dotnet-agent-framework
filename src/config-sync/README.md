...
| crm-agent | 6 | Foundry--ProjectEndpoint, Foundry--DeploymentName, Foundry--ToolboxName, CrmMcp--BaseUrl, KnowledgeMcp--BaseUrl, AzureAd--TenantId |
| product-agent | 6 | Foundry--ProjectEndpoint, Foundry--DeploymentName, Foundry--ToolboxName, KnowledgeMcp--BaseUrl, CrmMcp--BaseUrl, AzureAd--TenantId |
| orchestrator-agent | 5 | Foundry--ProjectEndpoint, Foundry--DeploymentName, CrmAgent--BaseUrl, ProductAgent--BaseUrl, AzureAd--TenantId |
...
| simple-agent | 3 | Foundry--ProjectEndpoint, Foundry--DeploymentName, AzureAd--TenantId |
