...
// Loads the Product Agent's system prompt from `Prompts/system-prompt.md`
...
// from its training cutoff when reasoning about seasonal recommendations
// or promotion validity windows.
