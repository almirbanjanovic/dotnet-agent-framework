...
After infrastructure is deployed, run the **config-sync** tool to pull secrets from Key Vault into per-component `appsettings.{Environment}.json` files. See [Lab 1 Step 2](../docs/lab-1.md#step-2--configure-app-settings) for full instructions.
...
| # | Lab | Description |
| --- | --- | --- |
| 0 | [Lab 0 — Prerequisites & Bootstrap](../docs/lab-0.md) | Choose your track (Local or Full Azure); one-time tooling and bootstrap |
| 1 | [Lab 1 — Infrastructure, Validation & Data Seeding](../docs/lab-1.md) | Deploy Azure infrastructure (or Foundry-only locally), validate with simple-agent, seed data |
| 2 | [Lab 2 — Single & Multi-Agent Workflows](../docs/lab-2.md) | Drive the existing agents; add a third specialist without touching the others |
| 3 | [Lab 3 — Human-in-the-Loop Workflows](../docs/lab-3.md) | Build an ambient, durable refund-risk workflow with Blazor operations review |
