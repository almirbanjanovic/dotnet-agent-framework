...
| 3 | Lab 3 — Human-in-the-Loop Workflows ([Local](../docs/labs/local/lab-3.md) / [Full Azure](../docs/labs/full-azure/lab-3.md)) | Build an ambient, durable refund-risk workflow with Blazor operations review |
