# Lab 0 — Bootstrap (Full Azure Track)

> **Track:** Full Azure — production-shaped: AKS pods, Cosmos DB, AI Search, GitHub OIDC.
> Looking for the Local Track instead? See [`../local/lab-0.md`](../local/lab-0.md).
...
Proceed to [Lab 1](lab-1.md) to deploy the Azure infrastructure and seed your databases.
