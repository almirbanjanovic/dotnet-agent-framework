...
The AI Search Knowledge Source automatically handles re-indexing on a 5-minute schedule.
...
contoso-sharepoint/**/*.pdf
   ...
   Terraform uploads to sharepoint-docs blob container
        │
        ▼
   AI Search indexer (auto-generated by Knowledge Source, 5-min schedule):
        │
