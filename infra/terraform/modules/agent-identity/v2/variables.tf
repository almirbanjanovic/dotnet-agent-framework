# =============================================================================
# Agent Identity Module v2 — Variables
# =============================================================================

variable "environment" {
  description = "Deployment environment (e.g., dev, staging, prod). Kept for module parity."
  type        = string
}

variable "resource_group_name" {
  description = "Resource group name (reserved for lookups and parity with v1 module usage)."
  type        = string
}
